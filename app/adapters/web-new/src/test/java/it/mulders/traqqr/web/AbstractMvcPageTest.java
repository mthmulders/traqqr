    ...
    public static class ResponseAssert extends ObjectAssert<Response> {
        ...
        public ResponseAssert hasViewName(String expectedViewName) {
            ...
            try {
                ...
                // This can happen if the response has no entity or if the entity has already been read. In either case,
                // we consider the assertion to have failed.
                failWithMessage(
                        "The HTTP response did not have an entity, or it  has already been consumed, so it was not possible to verify the view name. Expected view name was <%s>.",
                        expectedViewName);
            }
            return this;
        }
